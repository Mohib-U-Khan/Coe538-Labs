...
MULTIPLICAND FCB  $0A              ; First Number
MULTIPLIER   FCB  $0D              ; Second Number
PRODUCT      RMB  2               ; Result of Multiplication

            ORG   $5000
Entry:
_Startup:
            LDAA  MULTIPLICAND    ; Get the first number 
            LDAB  MULTIPLIER      ; Get the second number 
            MUL                   ; Multiply the two numbers
            STD  PRODUCT          ; Store the product into two bytes
